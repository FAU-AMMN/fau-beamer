...
%
%
\begin{frame}[fragile]{Switching the institute theme}
We can switch the institut theme throughout the presentation via the command \verb|\switchinstute{<inst>}|
\end{frame}
%
\switchinstitute{Phil}
%
\begin{frame}[fragile]{Switching the institute theme}
\verb|\switchinstute{Phil}|
\end{frame}
%
\section{Example Section switched institute theme}
%
\begin{frame}[t,title]{-}
	A frame using the \texttt{title option} in the switched institute theme.
\end{frame}
%
\switchinstitute{RW}
%
\begin{frame}[fragile]{Switching the institute theme}
	\verb|\switchinstute{RW}|
\end{frame}
%
\switchinstitute{Med}
%
\begin{frame}[fragile]{Switching the institute theme}
	\verb|\switchinstute{Med}|
\end{frame}
%
\switchinstitute{Nat}
%
\begin{frame}[fragile]{Switching the institute theme}
	\verb|\switchinstute{Nat}|
\end{frame}
%
\switchinstitute{Tech}
%
\begin{frame}[fragile]{Switching the institute theme}
	\verb|\switchinstute{Tech}|
\end{frame}
%
\switchinstitute{FAU}
